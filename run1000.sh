...
torchrun --standalone --nproc_per_node=gpu -m scripts.base_train -- --depth=32 --device_batch_size=8
...
torchrun --standalone --nproc_per_node=gpu -m scripts.mid_train -- --device_batch_size=8 --run=$WANDB_RUN
